...
function DragInit(){
	...
	var view_move = function(){
		...
		/*$(this).unbind("mouseleave").mouseleave(function(){
			...
			$(this).find(".drag>li").animate(
				{opacity: 0},
				250
			);
		});*/
	}
	$(".drag>li").parent().unbind("mouseenter").mouseenter(view_move);
	...
	var Actions = function(e){
		...
		$(window).mouseup(function(e){
				...
				if( new_list.is("input") ){
					...
					$("#move").animate(
						...
						function(){
							...
							$(".drag>li").unbind("mousedown").mousedown(Actions);
							$(".drag>li").parent().unbind("mouseenter").mouseenter(view_move);
			...
			$(".drag>li").animate( {opacity: 0}, 1000);
